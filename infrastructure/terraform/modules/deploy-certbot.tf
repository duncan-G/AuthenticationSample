# =============================================================================
# AWS IAM Role for GitHub Actions Certbot deployment
# =============================================================================
# This file manages all IAM components required for GitHub Actions to build and push certbot Docker image
# 
# • IAM role for GitHub Actions to build and push certbot Docker image
# • IAM policy for GitHub Actions to build and push certbot Docker image
# • IAM policy attachments for certbot workflow permissions

# Note: See ./.github/workflows/certbot-release.yml for deployment details
# =============================================================================
...
# GitHub Actions Certbot Role
resource "aws_iam_role" "github_actions_certbot" {
  name = "${var.project_name}-github-actions-role-certbot"
...
# GitHub Actions Certbot Policy
resource "aws_iam_policy" "github_actions_certbot_policy" {
  name        = "${var.project_name}-github-actions-policy-certbot"
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = [
          "arn:aws:s3:::${var.project_name}-certbot-${var.bucket_suffix}",
          "arn:aws:s3:::${var.project_name}-certbot-${var.bucket_suffix}/*"
        ]
      },
      {
...
# Attach certbot policy to certbot role
